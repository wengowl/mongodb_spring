...
public class MongoSpringTest {
    ...
    public void testAddUser() {
        User wengowl = new User();
        wengowl.setName("翁旭峰3");
        wengowl.setAge(27);
        List<String> interests = new ArrayList<String>();
        interests.add("stuty");
        interests.add("hello");
        wengowl.setInterest(interests);
        Home home = new Home("浙江");
        wengowl.setHome(home);

        // 插入数据
        mongoTemplate.insert(wengowl);
        System.out.println(wengowl.getId());
    }
...
//        Criteria criteria = where("age").gt(27);    // 大于
        Criteria criteria = where("id").is("5b90e76e6e6ff72e1c0203e1");    // 大于
        ...
        for (User user:userList1){
            ...
            System.out.println(user.getHome().getHome());
        ...
        // printList(userList2);
         ...
         // 排序　
//            Query query = new Query();
//          query.with(new Sort(Sort.Direction.ASC, "priority").and(new Sort(Sort.Direction.ASC, "create_time")));
    ...
    public void testUpdateUser() {
        ...
        // 更新age大于24的用户信息
        Query query = new Query();
        query.addCriteria(where("age").gt(27));
